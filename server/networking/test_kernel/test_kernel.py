...
import gi
from networking_python_sdk import swarm_net_init

print(os.environ)
print(sys.path)
gi.require_version("Gst", "1.0")
from networking_python_sdk.networking_pb2 import MediaChannel, State
...
if __name__ == "__main__":
    ...
    swarm_net = swarm_net_init()
    while True:
        event = swarm_net.eventQueue.get()
        # echo incoming data

...
class MediaSocketDirs(_message.Message):
    ...
    serverDir: str
    clientDir: str
    def __init__(self, serverDir: _Optional[str] = ..., clientDir: _Optional[str] = ...) -> None: ...
...
class Event(_message.Message):
    ...
    def __init__(self, data: _Optional[_Union[DataTransmission, _Mapping]] = ..., media: _Optional[_Union[MediaChannel, _Mapping]] = ..., achievedState: _Optional[_Union[State, _Mapping]] = ..., mediaSocketDirs: _Optional[_Union[MediaSocketDirs, _Mapping]] = ...) -> None: ...
